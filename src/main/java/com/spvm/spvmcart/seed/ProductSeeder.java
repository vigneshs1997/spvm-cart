...
@Component //Inorder to create Bean Component in Spring Container
public class ProductSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
         if(productRepo.count() == 0){//If product table is 0
             ...
             System.out.println("Products Already Exit! so Skipping Seed");
         }
    }
}
